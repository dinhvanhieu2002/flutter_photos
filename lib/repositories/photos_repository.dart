...
class PhotosRepository {
  ...
  Future<List<Photo>> searchPhotos({required String query, int page = 1}) async {
    try {
      final url = '$_unsplashBaseUrl/search/photos?client_id=${dotenv.get('UNSPLASH_ACCESS_TOKEN')}&page=$page&per_page=$numPerPage&query=$query';
